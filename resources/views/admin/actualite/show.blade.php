...
@section('content')
	<div class="app-title">
	  <div>
	    <h1><i class="fa fa-dashboard"></i> {!!$article->title!!}</h1>
              ...
              <div class="tab-pane fade" id="profile">
                <div class="p-x-5">
                  <div class="form-group row mb-4">
                    <div class="col-md-2">
                      <img src="{{ asset(optional($article->image)->path) }}" alt="" class="img-70 mr-3 img-thumbnail img-show">
                    </div>
                    <div class="col-md-8">
          ...
          <div class="p-x-5">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="state" id="status">
                ...
                <option value="2" {{$article->state === 2 ? 'selected':''}}>Archivé</option>
                <option value="-2" {{$article->state === -2 ? 'selected':''}}>Corbeille</option>
                @if ($article->state===3)
